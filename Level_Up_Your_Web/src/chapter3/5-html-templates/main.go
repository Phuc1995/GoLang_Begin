...
func main()  {
	...
	//Example 2
	goArticle := Article{
		Name: "The Go html/template package Example 2",
	...
	article := map[string]string{
		"Name": "The Go html/template package Example 3",
		"AuthorName": "Mal Curtis",
	}

	tmpl, err = template.New("Foo").Parse("{{.Name}} test {{.AuthorName}}\n")
	if err != nil {
		panic(err)
	}
	...
	// Example 8
	tmpl, err = template.New("Foo").Parse("Price: ${{printf \"%.1f\" .}}\n")
	if err != nil {
		panic(err)
	}
